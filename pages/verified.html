...
<body>
                ...
                <li class="nav-item">
                    <span class="nav-link">
                        ...
                        <span class = "dropdown">
                            ...
                            <a href="/pages/maps/other.html" class="nav-link">Other</a>
                        </span>
                    </span>
                </li>
                <li class="nav-item">
    ...
    <section class = "verified">
        ...
        <div class="ver-build">
            <img src="/img/FingerMapsLogoNewCircle.png" alt="verified-logo">
            <p class = "ver-name">FingerMaps</p>
            <a href="#" class = "ver-site">Visit Website</a>
        </div>
